...
urlpatterns = [
    ...
    path('doc/<slug:invoiceSlug>/', AddInvoiceItemsView.as_view(), name='addItems'),
    path('doc/<slug:invoiceSlug>/item/<int:itemId>/', EditInvoiceItemsView.as_view(), name='editItems'),
