# Generated by Django 4.2.1 on 2023-09-12 06:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_types', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='invoices.documenttypes', verbose_name='Rodzaj dokumentu')),
                ('type_contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='invoices.contracttypes')),
            ],
            options={
